...
class HeaderTextView(context: Context, attrs: AttributeSet?) : androidx.appcompat.widget.AppCompatTextView(
    context,
    attrs
) {
    ...
    init {
        try {
            ...
            val fontSize = a.getDimensionPixelSize(R.styleable.FieldLayout_right_detail_text_size, 18)
